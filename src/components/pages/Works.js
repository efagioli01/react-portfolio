                ...
                <div class="section-container">
                    ...
                    <div class="main-content">
                        <menu id="buttons-menu">
                            <button><a className="btns" buttonStyle="btn--outline" buttonSize='btn--large' href="/#front" target="_blank">FRONT END</a></button>
                            <button><a className="btns" buttonStyle="btn--outline" buttonSize='btn--large' href="/" target="_blank">MERN</a></button>
                            <button><a className="btns" buttonStyle="btn--outline" buttonSize='btn--large' href="/" target="_blank">FULL STACK</a></button>
